...
- **Админ-панель** для управления системой через веб-интерфейс
...
- **Spring Security** - безопасность админ-панели
...
Веб-интерфейс для управления системой доступен по адресу: `http://localhost:8080/admin`

### Доступ

- **URL**: `/admin`
- **Логин по умолчанию**: `admin` / `admin`
- Настройка через переменные окружения: `ADMIN_USERNAME` и `ADMIN_PASSWORD`

### Возможности

- **Дашборд** - общая статистика системы
- **Конфигурация** - настройка параметров рекомендаций в реальном времени
- **Пользователи** - управление пользователями и их предпочтениями
- **Треки** - управление музыкальными треками
- **Жанры** - управление жанрами музыки
- **Мониторинг** - статус системы и метрики

### Безопасность

Админ-панель защищена Spring Security с базовой HTTP аутентификацией. API endpoints остаются открытыми для интеграции.
...
- **Дашборд** - общая статистика системы
- **Конфигурация** - управление параметрами рекомендаций в реальном времени
- **Пользователи** - просмотр и редактирование пользователей, управление предпочтениями
- **Треки** - CRUD операции с треками, поиск, управление жанрами
- **Жанры** - создание и управление жанрами
- **Мониторинг** - доступ к метрикам и health checks
